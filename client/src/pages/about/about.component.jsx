    ...
    <Fade left delay={500} duration={2000}>
      <div className="about-text">
        ...
        <p>
          ...
          children in the city. Once leaving the school environment I continued
          making art for my own pleasure and to fulfill my need to create. I
          create my art and follow the flow of inspiration whenever and wherever
          it took me.
        </p>
        <p>
          My work studio is in my home where I find it very convenient to work
          at any time the creative urges arise. I work in a small studio with an
          outdoor deck which is in the back of my garden.
        </p>
      </div>
    </Fade>
